...
<html>
    ...
    <body>
        <h1>Lista de Coches del concesionario: <% request.getAttribute("id"); %></h1>
        <table>
            <tr>
                <td><a href="CarDealerships?action=list" >Atrás</a> </td>
                <td>- - -</td>
                <td><a href="CarDealerships?action=newcar" >Insertar Nuevo</a> </td>
                <td><a href="CarDealerships?action=removecar&id=all" >Borrar todos</a> </td>
            </tr>
        </table>
        ...
        <table border="1" width="100%">
            ...
            <c:forEach var="car" items="${list}">
                <tr>
                    ...
                    <td><a href="CarDealerships?action=removecar&id=<c:out value="${car.getId()}"/>">Eliminar</a> </td>				
                </tr>
            </c:forEach>
        </table>
    </body>
